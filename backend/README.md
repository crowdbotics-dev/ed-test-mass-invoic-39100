...
## Project Structure
    ...
    ├── ed_test_mass_invoic_39100  # Django project configurations
...
1. Clone this repo and `cd ed_test_mass_invoic_39100`
...
2. Clone this repo and `cd ed_test_mass_invoic_39100`
